...
| S4 | Wave 4 (post-run-6) — F14 + F19 + F9 + mechanical-18 framework | **done; awaiting operator final S6 verification** | F14: `a29f581`. F19: `a11430f`. F9: `8c258f7`. Mechanical-18 framework: (this commit). | All Wave 4 fixes in non-frozen `.cpp`; frozen-surface counter remains 0/2. Mechanical-18 framework scaffolds T3 today; T1/T2/T5/T7/T8/T10/T11 are V1.0.1 follow-up automation candidates per `tests/integration/gui/README.md` |
