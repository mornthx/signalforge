...
| S4 | Critical bug fixes (Waves 1/2/3) | **Wave 1 done; Wave 2 next** | Wave 1: `7ed9d7b` diag + (this commit) closure | Wave 1: F4 closed (Path α — production OK; smoke uses `SF_F4_DIAG=1` canary). Wave 2: F6 + F17. Wave 3: F11 + F15 + F12 + F18 |
