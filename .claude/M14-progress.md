...
| S4 | Critical bug fixes (Waves 1/2/3) | **Wave 1+2 implementation done; Wave 2 awaiting operator validation** | Wave 1: `7ed9d7b`, `cbf7a25`. Wave 2: (this commit). Wave 3: pending | Wave 1: F4 closed (Path α — production OK; smoke uses `SF_F4_DIAG=1` canary). Wave 2: F6 (always-subscribe SessionWriter) + F17 (set configPath_ unconditionally + aboutToQuit save) — ADR-013. Wave 3: F11 + F15 + F12 + F18 |
