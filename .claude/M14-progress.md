...
| S5 | V1.0 scope re-evaluation (Scenario A/B/C) | **CC drafted; awaiting human ratification** | (this commit) | `docs/v1.0-scope-evaluation.md` recommends Scenario A — V1.0 full ship after S6 18-test ≥ 16/18 |
