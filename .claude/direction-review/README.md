...
| [DR-002](DR-002-2026-05-30-three-tier-workbench.md) | 2026-05-30 | Whole-product IA: raw → parsed → dashboard | Drifting: only Observe built; recovered §7.2 via 3 tiers (Raw/Parsed/Dashboard) | **Resolved** (local, unpushed) — A (M29) + B (M30) + C (M31) landed; dissection tree → M32 |
