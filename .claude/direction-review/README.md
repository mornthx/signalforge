...
| [DR-002](DR-002-2026-05-30-three-tier-workbench.md) | 2026-05-30 | Whole-product IA: raw → parsed → dashboard | Drifting: only Observe built; recover the §7.2 Decode workspace via 3 tiers | **Open** — Phase A (M29) + B (M30) done; C (M31) pending |
